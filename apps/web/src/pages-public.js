  ...
  return `
    <div class="pub-topbar">
      <div class="pub-topbar-logo" onclick="window._navPublic('home')">
        <div class="logo-icon" style="width:38px;height:38px;background:url('/deepsynaps-logo.png') center/115%;border-radius:50%"></div>
        <div>
  ...
  el.insertAdjacentHTML('beforeend', `
    ...
    <div class="pub-footer">
      <div class="pub-footer-logo">
        <div class="logo-icon" style="width:30px;height:30px;background:url('/deepsynaps-logo.png') center/115%;border-radius:50%"></div>
    ...
    <div class="pub-signup-wrap">
      <div class="pub-signup-card">
        ...
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:20px">
          <div class="logo-icon" style="width:44px;height:44px;background:url('/deepsynaps-logo.png') center/115%;border-radius:50%"></div>
          <div>
