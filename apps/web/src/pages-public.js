  ...
  return `
    <div class="pub-topbar">
      <div class="pub-topbar-logo" onclick="window._navPublic('home')">
        <div class="logo-icon" style="width:32px;height:32px;font-size:13px;background:url('/deepsynaps-logo.png') center/cover;border-radius:50%"></div>
        <div>
  ...
  el.insertAdjacentHTML('beforeend', `
    ...
    <div class="pub-footer">
      <div class="pub-footer-logo">
        <div class="logo-icon" style="width:24px;height:24px;font-size:11px;background:url('/deepsynaps-logo.png') center/cover;border-radius:50%"></div>
    ...
    <div class="pub-signup-wrap">
      <div class="pub-signup-card">
        ...
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:20px">
          <div class="logo-icon" style="width:36px;height:36px;font-size:15px;background:url('/deepsynaps-logo.png') center/cover;border-radius:50%"></div>
          <div>
  ...
  el.innerHTML = `
    ...
    <div class="pub-signup-wrap">
      <div class="pub-signup-card">
        <button class="pub-back-link" onclick="window._navPublic('home')">&#8592; Back to home</button>
        <div style="display:flex;align-items:center;gap:10px;margin-bottom:20px">
          <div class="logo-icon" style="width:36px;height:36px;font-size:16px;background:url('/deepsynaps-logo.png') center/cover;border-radius:50%"></div>
          <div>
            <div style="font-size:10px;color:var(--text-tertiary);text-transform:uppercase;letter-spacing:1px">DeepSynaps Protocol Studio</div>
