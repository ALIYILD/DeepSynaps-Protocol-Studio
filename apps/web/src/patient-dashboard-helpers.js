...
// ── Offline Demo Patient Roster (synthetic non-PHI preview) ─────────────────
// Used only when VITE_ENABLE_DEMO=1 or dev + API empty/unreachable — never silent in prod.
/**
 * @param {number} [nowMs]
 * @returns {Record<string, unknown>[]}
 */
export function buildDemoPatientRosterPreview(nowMs = Date.now()) {
  const isoDay = (daysAgo) => new Date(nowMs - daysAgo * 86400000).toISOString().slice(0, 10);
  const todayAt = (h, m) => {
  ...
  return [
    {
      ...
      dob: '1992-03-14', gender: 'Female', age: 34,
      ...
      consent_signed: true,
      demo_seed: true,
      notes: '[DEMO] Synthetic preview — MDD / tDCS (non-PHI)',
      created_at: isoDay(90),
      next_session_at: todayAt(10, 30),
      next_session_date: todayDateStr,
      next_session_id: 'demo-sess-samantha-today',
      todays_session_id: 'demo-sess-samantha-today',
      ...
      needs_review: false,
      is_responder: false,
      last_session_date: isoDay(3),
    },
    {
      id: 'demo-pt-marcus-chen',
      first_name: 'Marcus', last_name: 'Chen',
      dob: '1985-07-22', gender: 'Male', age: 41,
      ...
      consent_signed: true,
      demo_seed: true,
      notes: '[DEMO] Synthetic preview — GAD / rTMS (non-PHI)',
      created_at: isoDay(60),
      next_session_at: null,
      next_session_date: isoDay(2),
    ...
    },
    {
      ...
      dob: '1978-11-05', gender: 'Female', age: 47,
      ...
      consent_signed: true,
      demo_seed: true,
      notes: '[DEMO] Synthetic preview — PTSD / TPS (non-PHI)',
      created_at: isoDay(45),
      next_session_date: isoDay(1),
      next_session_at: null,
    ...
    },
    {
      ...
      dob: '1999-01-30', gender: 'Male', age: 27,
      ...
      demo_seed: true,
      notes: '[DEMO] Synthetic preview — ADHD / Neurofeedback intake (non-PHI)',
      created_at: isoDay(5),
    ...
    },
    {
      ...
      first_name: 'Amelia', last_name: 'Brown',
      dob: '1988-09-18', gender: 'Female', age: 38,
      primary_condition: 'Migraine',
      condition_slug: 'migraine',
      primary_modality: 'Biofeedback',
      status: 'discharging',
      consent_signed: true,
      demo_seed: true,
      notes: '[DEMO] Synthetic preview — Migraine / Biofeedback (non-PHI)',
      created_at: isoDay(120),
      next_session_date: isoDay(7),
      sessions_delivered: 18,
      planned_sessions_total: 20,
      home_adherence: 0.81,
      primary_scale: 'HIT-6',
      baseline_score: 62,
...
/** @deprecated Prefer buildDemoPatientRosterPreview() for time-sensitive preview fields. */
export const DEMO_PATIENT_ROSTER = Object.freeze(buildDemoPatientRosterPreview());
