...
async function loadTreatmentSessionsAnalyzer() {
  return (_modTreatmentSessionsAnalyzer ??= await import('./pages-treatment-sessions-analyzer.js'));
}
...
const NAV = [
  ...
  { id: 'treatment-sessions-analyzer', label: 'Sessions', icon: '⚡', ai: true },
...
NAV_ICONS['treatment-sessions-analyzer'] = `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M13 2 3 14h9l-1 8 10-12h-9l1-8z"/></svg>`;
...
async function renderPage() {
  ...
  switch (currentPage) {
    ...
    case 'treatment-sessions-analyzer': {
      const m = await loadTreatmentSessionsAnalyzer();
      await m.pgTreatmentSessionsAnalyzer(setTopbar, navigate);
      break;
    }
...
(function initCommandPalette() {
  ...
  NAV_COMMANDS.push(
    ...
    { type: 'nav', icon: '⚡', title: 'Treatment Sessions Analyzer', page: 'treatment-sessions-analyzer' },
  );
