...
function renderDisclaimer(report, variant) {
  var disclaimer = (report && report.disclaimer)
    || 'Decision-support only. This brain map summary is informational and is not a medical diagnosis or treatment recommendation. Discuss any findings with a qualified clinician.';
