      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="relative">
          {jwtToken ? (
            ...
            <Link
              to="/login"
              className="inline-flex items-center justify-center rounded-xl px-4 py-2.5 font-medium transition text-[var(--text-muted)] hover:bg-[var(--accent-soft)] hover:text-[var(--text)] focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[var(--accent)] text-sm"
            >
              Sign In
            </Link>
          )}
