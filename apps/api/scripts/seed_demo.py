...
_MARKETPLACE_ITEMS = [
    # ── Wearables ─────────────────────────────────────────────────────────────
    {"id":"amz-oura-ring-4","kind":"product","name":"Oura Ring Gen 4","provider":"Oura Health","description":"Titanium smart ring with advanced sleep staging, HRV, blood oxygen, and activity tracking. 7-day battery life. Compatible with iOS and Android.","price":349.0,"price_unit":"USD","clinical":False,"featured":True,"tags_json":json.dumps(["Wearable","Sleep tracking","HRV","7-day battery"]),"external_url":"https://www.amazon.com/dp/B0DKLHHMZ5","icon":"💍","tone":"blue"},
    {"id":"amz-apple-watch-se","kind":"product","name":"Apple Watch SE (2nd Gen)","provider":"Apple","description":"GPS + Cellular smartwatch with heart rate, sleep, crash detection, and ECG. Deep integration with Apple Health and fitness tracking.","price":249.0,"price_unit":"USD","clinical":False,"featured":False,"tags_json":json.dumps(["Smartwatch","ECG","Crash detection","Apple Health"]),"external_url":"https://www.amazon.com/dp/B0CHX1W1XY","icon":"⌚","tone":"teal"},
    {"id":"amz-garmin-vivosmart","kind":"product","name":"Garmin vivosmart 5","provider":"Garmin","description":"Fitness tracker with stress tracking, Body Battery energy monitoring, sleep score, and Garmin Connect integration.","price":149.99,"price_unit":"USD","clinical":False,"featured":False,"tags_json":json.dumps(["Fitness tracker","Stress tracking","Body Battery"]),"external_url":"https://www.amazon.com/dp/B09W1TVFS7","icon":"📱","tone":"green"},
    # ── Heart Rate & HRV ──────────────────────────────────────────────────────
    {"id":"amz-polar-h10","kind":"product","name":"Polar H10 Heart Rate Sensor","provider":"Polar","description":"Medical-grade ECG chest strap with dual Bluetooth + ANT+ connectivity. Internal memory for one training session. Waterproof up to 30m. 400h battery life.","price":89.95,"price_unit":"USD","clinical":False,"featured":True,"tags_json":json.dumps(["HRV","ECG","Chest strap","Waterproof"]),"external_url":"https://www.amazon.com/dp/B07PM54P4N","icon":"🫀","tone":"rose"},
    {"id":"amz-garmin-hrm-dual","kind":"product","name":"Garmin HRM-Dual","provider":"Garmin","description":"Premium heart rate monitor chest strap with Bluetooth and ANT+ transmission. Soft, adjustable strap. Replaceable battery.","price":69.99,"price_unit":"USD","clinical":False,"featured":False,"tags_json":json.dumps(["Heart rate","Bluetooth","ANT+","Running"]),"external_url":"https://www.amazon.com/dp/B07N1GX6W1","icon":"💓","tone":"blue"},
    # ── EEG / Meditation ──────────────────────────────────────────────────────
    {"id":"amz-muse-2","kind":"product","name":"Muse 2 Brain Sensing Headband","provider":"Interaxon","description":"EEG-powered meditation headband with real-time biofeedback. Tracks brain activity, heart rate, breathing, and body movement during meditation sessions.","price":199.99,"price_unit":"USD","clinical":False,"featured":True,"tags_json":json.dumps(["EEG","Meditation","Biofeedback","Neurofeedback"]),"external_url":"https://www.amazon.com/dp/B07HL2JQQJ","icon":"🧘","tone":"violet"},
    {"id":"amz-muse-s","kind":"product","name":"Muse S Gen 2 Sleep & Meditation Headband","provider":"Interaxon","description":"Soft fabric EEG headband for sleep tracking and guided meditation. Monitors brain activity, heart rate, and movement. Includes sleep journeys and overnight tracking.","price":299.99,"price_unit":"USD","clinical":False,"featured":False,"tags_json":json.dumps(["EEG","Sleep tracking","Meditation","Comfort"]),"external_url":"https://www.amazon.com/dp/B0815J7FYP","icon":"😴","tone":"teal"},
    # ── Light Therapy ─────────────────────────────────────────────────────────
    {"id":"amz-verilux-happylight","kind":"product","name":"Verilux HappyLight Touch Plus","provider":"Verilux","description":"10,000 lux UV-free LED light therapy lamp with adjustable brightness, color temperature, and countdown timer. Clinically proven to improve mood, energy, and sleep.","price":64.99,"price_unit":"USD","clinical":False,"featured":True,"tags_json":json.dumps(["Light therapy","10 000 lux","UV-free","Mood"]),"external_url":"https://www.amazon.com/dp/B07WC7KT4G","icon":"☀️","tone":"amber"},
    {"id":"amz-carex-daylight","kind":"product","name":"Carex Day-Light Classic Plus","provider":"Carex","description":"Clinical-grade 10,000 lux bright light therapy lamp at 12 inches. Adjustable height and angle. LED sun lamp for seasonal mood support and low energy.","price":167.27,"price_unit":"USD","clinical":False,"featured":False,"tags_json":json.dumps(["Light therapy","10 000 lux","Clinical-grade","LED"]),"external_url":"https://www.amazon.com/dp/B0027M3SPG","icon":"💡","tone":"amber"},
    # ── Sleep Aids ────────────────────────────────────────────────────────────
    {"id":"amz-lectrofan","kind":"product","name":"LectroFan Evo White Noise Machine","provider":"Adaptive Sound Technologies","description":"High-fidelity white noise, fan, and ocean sounds with precise volume control. 22 non-looping sounds. Sleep timer and USB power.","price":49.95,"price_unit":"USD","clinical":False,"featured":False,"tags_json":json.dumps(["White noise","Sleep aid","Non-looping","USB"]),"external_url":"https://www.amazon.com/dp/B07XXR2NVB","icon":"🔊","tone":"slate"},
    {"id":"amz-manta-sleep-mask","kind":"product","name":"Manta Sleep Mask","provider":"Manta Sleep","description":"Adjustable eye cups for 100% blackout. Zero eye pressure design. Machine washable. Includes cooling eye cups for headaches and puffy eyes.","price":35.0,"price_unit":"USD","clinical":False,"featured":False,"tags_json":json.dumps(["Sleep mask","Blackout","Zero pressure","Cooling"]),"external_url":"https://www.amazon.com/dp/B07L5LPSQT","icon":"🎭","tone":"violet"},
    {"id":"amz-weighted-blanket","kind":"product","name":"YnM Weighted Blanket (15 lbs)","provider":"YnM","description":"100% natural cotton weighted blanket with glass beads. 7-layer design for even weight distribution. Breathable and machine washable duvet cover.","price":69.9,"price_unit":"USD","clinical":False,"featured":False,"tags_json":json.dumps(["Weighted blanket","Deep pressure","Cotton","Glass beads"]),"external_url":"https://www.amazon.com/dp/B01LQMOCJI","icon":"🛏️","tone":"blue"},
    # ── Recovery & Wellness ───────────────────────────────────────────────────
    {"id":"amz-triggerpoint-grid","kind":"product","name":"TriggerPoint GRID Foam Roller","provider":"TriggerPoint","description":"Patented multi-density foam roller with hollow core. Designed for self-myofascial release, muscle recovery, and improved mobility.","price":37.99,"price_unit":"USD","clinical":False,"featured":False,"tags_json":json.dumps(["Foam roller","Recovery","Mobility","Myofascial"]),"external_url":"https://www.amazon.com/dp/B0040EGNIU","icon":"🌀","tone":"green"},
    {"id":"amz-gaiam-yoga-mat","kind":"product","name":"Gaiam Essentials Thick Yoga Mat","provider":"Gaiam","description":"2/5-inch extra thick yoga mat with carrying strap. Non-slip surface for stability. Ideal for yoga, Pilates, and floor exercises.","price":24.98,"price_unit":"USD","clinical":False,"featured":False,"tags_json":json.dumps(["Yoga mat","Non-slip","Thick","Exercise"]),"external_url":"https://www.amazon.com/dp/B08TWK8G8J","icon":"🧘","tone":"teal"},
    {"id":"amz-resistance-bands","kind":"product","name":"Fit Simplify Resistance Loop Bands","provider":"Fit Simplify","description":"Set of 5 resistance bands with instruction guide and carry bag. Varying resistance levels for strength training, physical therapy, and stretching.","price":12.95,"price_unit":"USD","clinical":False,"featured":False,"tags_json":json.dumps(["Resistance bands","Strength","Physical therapy","Portable"]),"external_url":"https://www.amazon.com/dp/B01AVDVHTI","icon":"💪","tone":"rose"},
    # ── Health Monitoring ─────────────────────────────────────────────────────
    {"id":"amz-omron-bp-monitor","kind":"product","name":"Omron Bronze Blood Pressure Monitor","provider":"Omron","description":"Upper arm blood pressure monitor with wide-range D-ring cuff. Stores up to 14 readings. Irregular heartbeat detection. Clinically validated accuracy.","price":39.99,"price_unit":"USD","clinical":False,"featured":False,"tags_json":json.dumps(["Blood pressure","Heart health","Clinically validated","Omron"]),"external_url":"https://www.amazon.com/dp/B07N1T7N1P","icon":"🩺","tone":"red"},
    {"id":"amz-pulse-oximeter","kind":"product","name":"Zacurate Pro Series Pulse Oximeter","provider":"Zacurate","description":"Fingertip pulse oximeter with OLED display. Measures SpO2 and pulse rate. Includes silicon cover, batteries, and lanyard. Suitable for sports and aviation use.","price":22.95,"price_unit":"USD","clinical":False,"featured":False,"tags_json":json.dumps(["Pulse oximeter","SpO2","OLED","Portable"]),"external_url":"https://www.amazon.com/dp/B07PQ8WBD4","icon":"🫁","tone":"blue"},
    # ── Books ─────────────────────────────────────────────────────────────────
    {"id":"amz-book-neuroplasticity","kind":"product","name":"The Brain That Changes Itself","provider":"Norman Doidge","description":"Stories of personal triumph from the frontiers of brain science. Explores neuroplasticity and how the brain can heal itself through mental exercise.","price":14.29,"price_unit":"USD","clinical":False,"featured":False,"tags_json":json.dumps(["Book","Neuroplasticity","Brain science","Bestseller"]),"external_url":"https://www.amazon.com/dp/0143113100","icon":"📚","tone":"amber"},
    {"id":"amz-book-cbt","kind":"product","name":"Feeling Good: The New Mood Therapy","provider":"David D. Burns","description":"The classic guide to cognitive behavioral therapy. Clinically proven techniques to lift depression and anxiety without medication.","price":10.39,"price_unit":"USD","clinical":False,"featured":False,"tags_json":json.dumps(["Book","CBT","Depression","Anxiety"]),"external_url":"https://www.amazon.com/dp/0380810336","icon":"📖","tone":"blue"},
]
