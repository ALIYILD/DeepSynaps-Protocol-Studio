...
try:
    ...
    class DrugBankAdapter: pass
    class RxNormAdapter: pass
    class PharmGKBAdapter: pass
    class OpenFDAAdapter: pass
    class ChEMBLAdapter: pass
    class PubChemAdapter: pass
...
try:
    ...
    class FAERSAdapter: pass
    class OnSIDESAdapter: pass
    class SIDERAdapter: pass
    class AEOLUSAdapter: pass
    class OFFSIDESTWOSIDESAdapter: pass
...
try:
    ...
    class DailyMedAdapter: pass
    class OrangeBookAdapter: pass
    class NDCDirectoryAdapter: pass
    class UNIIAdapter: pass
