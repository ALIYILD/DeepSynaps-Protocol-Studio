...
class DeepTwinBridge:
    ...
    def __init__(
        ...
        med_bridge: Optional[Any] = None,
        gen_bridge: Optional[Any] = None,
        qeeg_bridge: Optional[Any] = None,
        mri_bridge: Optional[Any] = None,
        evidence_store: Optional[EvidenceStore] = None,
    ) -> None:
        self.registry = registry
        self.synthesizer = synthesizer
        self.med_bridge = med_bridge or (MedicationAnalyzerBridge(registry) if MedicationAnalyzerBridge else None)
        self.gen_bridge = gen_bridge or (GeneticAnalyzerBridge(registry) if GeneticAnalyzerBridge else None)
        self.qeeg_bridge = qeeg_bridge or (QEEGAnalyzerBridge(registry) if QEEGAnalyzerBridge else None)
        self.mri_bridge = mri_bridge or (MRIAnalyzerBridge(registry) if MRIAnalyzerBridge else None)
    ...
    async def generate_patient_intelligence(self, patient_id: str) -> Dict[str, Any]:
        ...
        if self.med_bridge and medications:
            bridge_tasks.append(
                self._safe_call(
                    "med_bridge",
        ...
        if self.gen_bridge and genetic_variants:
