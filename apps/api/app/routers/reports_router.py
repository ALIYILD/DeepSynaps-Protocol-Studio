...
# ── Phase 2: QEEG Brain Map render endpoints ────────────────────────────────
# Renders the canonical QEEGBrainMapReport payload (Phase 0) into the
# clinician/patient PDF that mirrors the Phase 1 frontend layout. Falls back
# to HTML when ?format=html is passed. WeasyPrint absence → 503.
