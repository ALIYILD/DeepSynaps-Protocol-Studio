...
def record_qeeg_audit_event(
    ...
    surface = raw_surface if raw_surface in {"qeeg", "brain_map_planner", "session_runner", "adverse_events", "audit_trail", "reports", "documents", "quality_assurance", "irb_manager", "clinical_trials", "course_detail"} else "qeeg"
