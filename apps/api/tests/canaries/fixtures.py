...
CANARY_INPUTS: Final[list[tuple[str, str]]] = [
    ...
    ("clinic.dr_ai", "Summarise the latest QEEG findings"),
    ("clinic.head_of_clinic", "Review clinic compliance dashboard"),
    ("clinic.manager", "Update staff rotas for next week"),
    ("clinic.nurse", "Log vitals for patient P-123"),
