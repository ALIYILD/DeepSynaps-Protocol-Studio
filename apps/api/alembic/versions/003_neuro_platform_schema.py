...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column('on_label', sa.Boolean(), nullable=False, server_default=sa.text("true")),
    ...
    op.create_table(
        ...
        sa.Column('interruptions', sa.Boolean(), nullable=False, server_default=sa.text("false")),
    ...
    op.create_table(
        ...
        sa.Column('qeeg_supported', sa.Boolean(), nullable=False, server_default=sa.text("false")),
    ...
    op.create_table(
        ...
        sa.Column('baseline_assessments_complete', sa.Boolean(), nullable=False, server_default=sa.text("false")),
