"""Fusion Workbench schema.

Adds FusionCase, FusionCaseAudit, and FusionCaseFinding tables for
persistent, review-governed multimodal case summaries.
"""

from alembic import op
import sqlalchemy as sa

revision = "054_fusion_workbench"
down_revision = "c0b935c5df54"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    op.create_index("ix_fusion_cases_report_state", "fusion_cases", ["report_state"])
...
def downgrade() -> None:
    ...
    op.drop_index("ix_fusion_cases_report_state", table_name="fusion_cases")
